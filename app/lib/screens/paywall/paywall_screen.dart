  ...
  void _onPurchase() async {
    ...
    if (success) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Satın alma iptal edildi veya başarısız oldu.'),
            backgroundColor: AppTheme.danger,
          ),
        );
      }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        S.of(context)?.paywallTitle ?? 'PRO TAMİRCİ',
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      _buildFeatureRow(
                        Icons.bolt,
                        S.of(context)?.paywallFeature1 ??
                            'Sınırsız Enerji (Beklemek yok)',
                      ),
                      const SizedBox(height: 8),
                      _buildFeatureRow(
                        Icons.lightbulb,
                        S.of(context)?.paywallFeature2 ??
                            'Her vaka için sınırsız ipucu',
                      ),
                      const SizedBox(height: 8),
                      _buildFeatureRow(
                        Icons.block,
                        S.of(context)?.paywallFeature3 ??
                ...
                ref
                    ...
                    .when(
                      ...
                      error: (err, st) => Padding(
                        ...
                        child: Text(
                          'Fiyatlar yüklenemedi: $err',
                          style: const TextStyle(color: AppTheme.danger),
                        ),
                      ),
                      data: (offerings) {
                        if (offerings == null)
                          return const Text('Fiyatlar bulunamadı');

                        final offering = widget.isFomo
                            ? offerings.all['fomo']
                            : offerings.current;
                        if (offering == null)
                          return const Text('Teklif bulunamadı');
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        S.of(context)?.termsOfUse ?? 'Terms of Use',
                        style: const TextStyle(
